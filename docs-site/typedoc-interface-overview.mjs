...
class KeyHoldDocsThemeContext extends MarkdownThemeContext {
...
class KeyHoldDocsTheme extends MarkdownTheme {
  getRenderContext(page) {
    return new KeyHoldDocsThemeContext(this, page, this.application.options);
  }
}

export function load(app) {
  app.renderer.defineTheme("keyhold-docs", KeyHoldDocsTheme);
}
